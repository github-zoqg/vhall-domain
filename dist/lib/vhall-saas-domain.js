(function (global, factory) {
  ...
  };var options=merge.recursive({},defaultOptions,customOptions);console.log("optionssssssssssssssssssssssssssss",options);return new Promise(function(resolve,reject){var onSuccess=function onSuccess(event){_this.instance=event.vhallrtc;_this.currentStreams=event.currentStreams;_this.listenEvents();console.log('init interactive sdk success:',event);successCb(event);resolve(event);};var onFail=function onFail(event){console.log('fail:',event);failCb(event);reject(event);};VhallRTC.createInstance(options,onSuccess,onFail);});}},{key:"listenEvents",value:function listenEvents(){var _this2=this;this.instance.on(VhallRTC.EVENT_REMOTESTREAM_ADD,function(e){// 远端流加入事件
  console.log('5555555remote stream added');_this2.$emit(VhallRTC.EVENT_REMOTESTREAM_ADD,e);});this.instance.on(VhallRTC.EVENT_REMOTESTREAM_REMOVED,function(e){// 远端流离开事件
  _this2.$emit(VhallRTC.EVENT_REMOTESTREAM_REMOVED,e);});this.instance.on(VhallRTC.EVENT_ROOM_EXCDISCONNECTED,function(e){// 房间信令异常断开事件
  _this2.$emit(VhallRTC.EVENT_ROOM_EXCDISCONNECTED,e);});this.instance.on(VhallRTC.EVENT_REMOTESTREAM_MUTE,function(e){// 远端流音视频状态改变事件
  _this2.$emit(VhallRTC.EVENT_REMOTESTREAM_MUTE,e);});this.instance.on(VhallRTC.EVENT_REMOTESTREAM_FAILED,function(e){// 本地推流或订阅远端流异常断开事件
  _this2.$emit(VhallRTC.EVENT_REMOTESTREAM_FAILED,e);});this.instance.on(VhallRTC.EVENT_STREAM_END,function(e){// 本地流采集停止事件(处理拔出设备和桌面共享停止时)
  _this2.$emit(VhallRTC.EVENT_STREAM_END,e);});this.instance.on(VhallRTC.EVENT_STREAM_STUNK,function(e){// 本地流视频发送帧率异常事件
  _this2.$emit(VhallRTC.EVENT_STREAM_STUNK,e);});this.instance.on(VhallRTC.EVENT_DEVICE_CHANGE,function(e){// 新增设备或移除设备时触发
  _this2.$emit(VhallRTC.EVENT_DEVICE_CHANGE,e);});}/**
         * 销毁互动sdk
         * @returns -- 销毁互动sdk
         */},{key:"destroyInit",value:function destroyInit(){var _this3=this;return new Promise(function(resolve,reject){_this3.instance.destroyInstance({}).then(function(){resolve();_this3.instance=null;})["catch"](function(error){reject(error);});});}/**
         * 创建本地流
         * @param obt {Object} - sdk init stream base info config
         * @return {Promise} - 创建成功后的promise 回调
         *
         */},{key:"createLocalStream",value:function createLocalStream(){var _this4=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){_this4.instance.createStream(options).then(function(data){resolve(data.streamId);})["catch"](function(error){if(store.get('roomInitData').userInfo.role_name!=1){//上麦人员无法创建本地流上麦，向外抛出信息
  var toSpeakInfo=_objectSpread2({roleName:store.get('roomInitData').userInfo.role_name,accountId:store.get('roomInitData').userInfo.third_party_user_id,nickName:store.get('roomInitData').userInfo.nickname},error);reject(toSpeakInfo);}else {reject(error);}});});}/**
         ...
         * @return {Promise} - 创建成功后的promise 回调
         *
         */},{key:"createLocalVideoStream",value:function createLocalVideoStream(){var _this5=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var addConfig=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return new Promise(function(resolve,reject){var defaultOptions={videoNode:options.videoNode,// 必填，传入本地视频显示容器ID
  ...
  };var params=merge.recursive({},defaultOptions,addConfig);console.log('pass params::',params);_this5.instance.createStream(params).then(function(data){resolve(data.streamId);})["catch"](function(error){if(store.get('roomInitData').userInfo.role_name!=1){//上麦人员无法创建本地流上麦，向外抛出信息
  ...
  attributes:JSON.stringify({roleName:store.get('roomInitData').userInfo.role_name,accountId:store.get('roomInitData').userInfo.third_party_user_id,nickName:store.get('roomInitData').userInfo.nickname})//选填，自定义信息，支持字符串类型
  };var params=merge.recursive({},defaultOptions,addConfig);_this6.instance.createStream(params).then(function(data){resolve(data.streamId);})["catch"](function(error){if(store.get('roomInitData').userInfo.role_name!=1){//上麦人员无法创建本地流上麦，向外抛出信息
  var toSpeakInfo=_objectSpread2({roleName:store.get('roomInitData').userInfo.role_name,accountId:store.get('roomInitData').userInfo.third_party_user_id,nickName:store.get('roomInitData').userInfo.nickname},error);reject(toSpeakInfo);}else {reject(error);}});});}/**
         * 创建本地音频流
         * @param obt {Object} - sdk init stream base info config  videoNode: 容器 audioDevice: 音频Id addConfig: 扩展配置项
         * @return {Promise} - 创建成功后的promise 回调
         *
         */},{key:"createLocalAudioStream",value:function createLocalAudioStream(){var _this7=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var addConfig=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return new Promise(function(resolve,reject){var defaultOptions={videoNode:options.videoNode,// 必填，传入本地视频显示容器ID
  audio:true,// 选填，是否采集音频设备，默认为true
  ...
  };var params=merge.recursive({},defaultOptions,addConfig);_this7.instance.createStream(params).then(function(data){resolve(data.streamId);})["catch"](function(error){reject(error);});});}/**
         * 创建图片推流
         * @param obt {Object} - sdk init stream base info config  videoNode: 容器 videoTrack: MediaStreamTrack对象,采集图像 addConfig: 扩展配置项
         * @return {Promise} - 创建成功后的promise 回调
         *
         */},{key:"createLocalPhotoStream",value:function createLocalPhotoStream(){var _this8=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var addConfig=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return new Promise(function(resolve,reject){var defaultOptions={videoNode:options.videoNode,// 传入本地视频显示容器，必填
  ...
  videoTrack:options.videoTrack//MediaStreamTrack对象
         ...
         * @returns 
         */},{key:"destroyStream",value:function destroyStream(){var _this9=this;var streamId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'';return new Promise(function(resolve,reject){_this9.instance.destroyStream({streamId:streamId}).then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         * 推送本地流到远端
         * @param {Object} options publish stream base info config  streamId：要推的流Id，accountId:用户Id
         * @return {Promise} - 推流成功后的promise 回调
         */},{key:"publishStream",value:function publishStream(){var _this10=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){_this10.instance.publish({streamId:options.streamId,accountId:options.accountId}).then(function(data){resolve(data);})["catch"](function(errInfo){reject(errInfo);});});}/**
         * 取消推送到远端的流
         * @param {String} streamId 要取消推的流Id
         * @returns {Promise} - 取消推流成功后的promise 回调
        */},{key:"unpublishStream",value:function unpublishStream(){var _this11=this;var streamId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'';return new Promise(function(resolve,reject){_this11.instance.unpublish({streamId:streamId}).then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         * 订阅远端流
         * @param {Object} options -- streamId:订阅的流id videoNode: 页面显示的容器 mute: 远端流的音视频 dual: 大小流 0小流 1大流
         * @returns {Promise} - 订阅成功后的promise 回调
         */},{key:"subscribeStream",value:function subscribeStream(){var _this12=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){var defaultOptions={videoNode:options.videoNode,// 传入本地视频显示容器，必填
  ...
  video:options.mute.audio||false// 是否关闭视频，默认false
  ...
  };var params=merge.recursive({},defaultOptions,addConfig);_this12.instance.subscribe(params).then(function(data){resolve(data);})["catch"](function(error){reject(error);});});}/**
         * 取消订阅远端流
         * @param {String} streamId -- 要取消订阅的流Id 
         * @returns {Promise} - 取消订阅成功后的promise 回调
         */},{key:"unSubscribeStream",value:function unSubscribeStream(){var _this13=this;var streamId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'';return new Promise(function(resolve,reject){_this13.instance.unsubscribe({streamId:streamId}).then(function(data){resolve(data);})["catch"](function(error){reject(error);});});}/**
         * 设置大小流
         * @param {Object} options streamId: 需要设置的流Id  dual: 0为小流 1为大流
         * @returns {Promise} - 设置订阅大小流成功后的promise回调
         */},{key:"setDual",value:function setDual(){var _this14=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){var params={streamId:options.streamId,dual:options.dual};_this14.instance.setDual(params).then(function(data){resolve(data);})["catch"](function(error){reject(error);});});}/**
         * 改变视频的禁用和启用
         * @param {Object} options streamId: 对哪一路流进行操作的流Id  isMute: true为禁用，false为启用
         * @returns {Promise} - 改变视频的禁用与开启后的promise 回调
         */},{key:"muteVideo",value:function muteVideo(){var _this15=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){var params={streamId:options.streamId,isMute:options.isMute};_this15.instance.muteVideo(params).then(function(data){resolve(data);})["catch"](function(error){reject(error);});});}/**
         * 改变音频的禁用和启用
         * @param {Object} options streamId: 对哪一路流进行操作的流Id isMute: true为禁用，false为启用
         * @returns {Promise} - 改变音频的禁用与开启后的promise 回调
         */},{key:"muteAudio",value:function muteAudio(){var _this16=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){var params={streamId:options.streamId,isMute:options.isMute};_this16.instance.muteAudio(params).then(function(data){resolve(data);})["catch"](function(error){reject(error);});});}/**
         * 开启旁路
         ...
         */},{key:"startBroadCast",value:function startBroadCast(){var _this17=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var addConfig=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return new Promise(function(resolve,reject){var defaultOptions={layout:options.layout||VhallRTC.CANVAS_LAYOUT_PATTERN_FLOAT_6_5D,// 旁路布局，选填 默认大屏铺满，一行5个悬浮于下面
  profile:options.profile||VhallRTC.BROADCAST_VIDEO_PROFILE_1080P_1,// 旁路直播视频质量参数
  paneAspectRatio:VhallRTC.BROADCAST_PANE_ASPACT_RATIO_16_9,//旁路混流窗格指定高宽比。  v2.3.2及以上
  border:options.border||{// 旁路边框属性
  width:2,color:'0x666666'}};var params=merge.recursive({},defaultOptions,addConfig);_this17.instance.startBroadCast(params).then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         * 停止旁路
         * @returns {Promise} - 停止旁路后的promise回调
         */},{key:"stopBroadCast",value:function stopBroadCast(){var _this18=this;return new Promise(function(resolve,reject){_this18.instance.stopBroadCast().then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         * 动态配置指定旁路布局模板
