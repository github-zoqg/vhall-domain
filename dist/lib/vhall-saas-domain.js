(function (global, factory) {
  ...
  function useMsgServer() {
    ...
    var sendGroupInfoAfterJoin = function sendGroupInfoAfterJoin(msgInstance) {
      var roomBaseServer = contextServer.get('roomBaseServer');
      var _roomBaseServer$state = roomBaseServer.state,
  ...
  function formatParams(data){var arr=[];if(data){for(var item in data){arr.push(encodeURIComponent(item)+'='+encodeURIComponent(data[item]));}}return arr.join('&');}// 随机数
  var Store=/*#__PURE__*/function(){function Store(){_classCallCheck(this,Store);this.state={};}_createClass(Store,[{key:"set",value:function set(key,value){this.state[key]=value;}},{key:"get",value:function get(key){return this.state[key];}}]);return Store;}();var store=new Store();var getRoomInfo=function getRoomInfo(res){var _data=res.data;return {webinar:{type:_data.webinar.type,id:_data.webinar.id},paasInfo:{channel_id:_data.interact.channel_id,inav_id:_data.interact.inav_id,paas_access_token:_data.interact.paas_access_token,paas_app_id:_data.interact.paas_app_id,room_id:_data.interact.room_id},userInfo:{avatar:_data.join_info.avatar,is_gag:_data.join_info.is_gag,is_kick:_data.join_info.is_kick,join_id:_data.join_info.join_id,nickname:_data.join_info.nickname,role_name:_data.join_info.role_name,third_party_user_id:_data.join_info.third_party_user_id},reportData:{guid:_data.report_data.guid,aid:_data.interact.room_id,report_extra:_data.report_data.report_extra}};};var commonjsGlobal=typeof globalThis!=='undefined'?globalThis:typeof window!=='undefined'?window:typeof global!=='undefined'?global:typeof self!=='undefined'?self:{};function getDefaultExportFromCjs(x){return x&&x.__esModule&&Object.prototype.hasOwnProperty.call(x,'default')?x['default']:x;}var src={exports:{}};(function(module,exports){Object.defineProperty(exports,"__esModule",{value:true});exports.isPlainObject=exports.clone=exports.recursive=exports.merge=exports.main=void 0;module.exports=exports=main;exports["default"]=main;function main(){var items=[];for(var _i=0;_i<arguments.length;_i++){items[_i]=arguments[_i];}return merge.apply(void 0,items);}exports.main=main;main.clone=clone;main.isPlainObject=isPlainObject;main.recursive=recursive;function merge(){var items=[];for(var _i=0;_i<arguments.length;_i++){items[_i]=arguments[_i];}return _merge(items[0]===true,false,items);}exports.merge=merge;function recursive(){var items=[];for(var _i=0;_i<arguments.length;_i++){items[_i]=arguments[_i];}return _merge(items[0]===true,true,items);}exports.recursive=recursive;function clone(input){if(Array.isArray(input)){var output=[];for(var index=0;index<input.length;++index){output.push(clone(input[index]));}return output;}else if(isPlainObject(input)){var output={};for(var index in input){output[index]=clone(input[index]);}return output;}else {return input;}}exports.clone=clone;function isPlainObject(input){return input&&_typeof$1(input)==='object'&&!Array.isArray(input);}exports.isPlainObject=isPlainObject;function _recursiveMerge(base,extend){if(!isPlainObject(base))return extend;for(var key in extend){if(key==='__proto__'||key==='constructor'||key==='prototype')continue;base[key]=isPlainObject(base[key])&&isPlainObject(extend[key])?_recursiveMerge(base[key],extend[key]):extend[key];}return base;}function _merge(isClone,isRecursive,items){var result;if(isClone||!isPlainObject(result=items.shift()))result={};for(var index=0;index<items.length;++index){var item=items[index];if(!isPlainObject(item))continue;for(var key in item){if(key==='__proto__'||key==='constructor'||key==='prototype')continue;var value=isClone?clone(item[key]):item[key];result[key]=isRecursive?_recursiveMerge(result[key],value):value;}}return result;}})(src,src.exports);var merge=/*@__PURE__*/getDefaultExportFromCjs(src.exports);/**
     * 判断终端类型
     *
     * @export
     * @param {*} target
  ...
  var getChatInitOptions=function getChatInitOptions(params){var _store$get4=store.get('roomInitData'),_store$get4$webinar=_store$get4.webinar,webinar=_store$get4$webinar===void 0?{}:_store$get4$webinar;var defaultParams={webinar_id:webinar.id};var retParmams=merge.recursive({},defaultParams,params);return new Promise(function(resolve,reject){$fetch({url:'/v3/webinars/live/get-connect',type:'GET',data:retParmams}).then(function(res){return resolve(res);})["catch"](function(e){return reject(e);});});};// 心跳检测
  var liveHeartBeat=function liveHeartBeat(params){return new Promise(function(resolve,reject){$fetch({url:'/v3/webinars/live/heartbeat',type:'GET',data:params}).then(function(res){return resolve(res);})["catch"](function(e){return reject(e);});});};// 获取live_token
  var getLiveToken=function getLiveToken(params){var _store$get5=store.get('roomInitData'),_store$get5$webinar=_store$get5.webinar,webinar=_store$get5$webinar===void 0?{}:_store$get5$webinar;var defaultParams={webinar_id:webinar.id};var retParmams=merge.recursive({},defaultParams,params);return new Promise(function(resolve,reject){$fetch({url:'/v3/webinars/live/get-live-token',type:'GET',data:retParmams}).then(function(res){return resolve(res);})["catch"](function(e){return reject(e);});});};// 获取推流地址
  var getStreamPushAddress=function getStreamPushAddress(params){var _store$get6=store.get('roomInitData'),_store$get6$webinar=_store$get6.webinar,webinar=_store$get6$webinar===void 0?{}:_store$get6$webinar;var defaultParams={webinar_id:webinar.id};var retParmams=merge.recursive({},defaultParams,params);return new Promise(function(resolve,reject){$fetch({url:'/v3/webinars/live/get-stream-push-address',type:'GET',data:retParmams}).then(function(res){return resolve(res);})["catch"](function(e){return reject(e);});});};var live={initSendLive:initSendLive,initStandardReceiveLive:initStandardReceiveLive,initEmbeddedReceiveLive:initEmbeddedReceiveLive,initSdkReceiveLive:initSdkReceiveLive,startLive:startLive,endLive:endLive,checkLive:checkLive,getChatInitOptions:getChatInitOptions,liveHeartBeat:liveHeartBeat,getLiveToken:getLiveToken,getStreamPushAddress:getStreamPushAddress};var RequestApi=function RequestApi(){_classCallCheck(this,RequestApi);this.live=live;};var requestApi=new RequestApi();var BaseModule=/*#__PURE__*/function(){function BaseModule(){_classCallCheck(this,BaseModule);_defineProperty(this,"handlers",{});}_createClass(BaseModule,[{key:"$on",value:// 事件添加方法，参数有事件名和事件方法
  function $on(type,handler){// 首先判断handlers内有没有type事件容器，没有则创建一个新数组容器
  if(!(type in this.handlers)){this.handlers[type]=[];}// 将事件存入
  this.handlers[type].push(handler);}// 触发事件两个参数（事件名，参数）
  },{key:"$emit",value:function $emit(type){for(var _len=arguments.length,params=new Array(_len>1?_len-1:0),_key=1;_key<_len;_key++){params[_key-1]=arguments[_key];}// 若没有注册该事件则抛出错误
  if(!(type in this.handlers)){return new Error('未注册该事件');}// 便利触发
  this.handlers[type].forEach(function(handler){handler.apply(void 0,params);});}// 事件移除参数（事件名，删除的事件，若无第二个参数则删除该事件的订阅和发布）
  },{key:"$off",value:function $off(type,handler){// 无效事件抛出
  if(!(type in this.handlers)){return new Error('无效事件');}if(!handler){// 直接移除事件
  delete this.handlers[type];}else {var idx=this.handlers[type].findIndex(function(ele){return ele===handler;});// 抛出异常事件
  if(idx===undefined){return new Error('无该绑定事件');}// 移除事件
  this.handlers[type].splice(idx,1);if(this.handlers[type].length===0){delete this.handlers[type];}}}}]);return BaseModule;}();var ChatModule=/*#__PURE__*/function(_BaseModule){_inherits(ChatModule,_BaseModule);var _super=_createSuper(ChatModule);function ChatModule(){_classCallCheck(this,ChatModule);return _super.call(this);}/**
       ...
       */_createClass(ChatModule,[{key:"init",value:function init(){var _this=this;var customOptions=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var defaultOptions=this.initDefaultOptions();var options=merge.recursive({},defaultOptions,customOptions);options.context=JSON.stringify(options.context);return new Promise(function(resolve,reject){VhallChat.createInstance(options,function(event){_this.instance=event.message;_this.listenEvents();resolve(event);},reject);});}/**
         ...
         */},{key:"initDefaultOptions",value:function initDefaultOptions(){var isPcClient=isPc();var _store$get=store.get('roomInitData'),paasInfo=_store$get.paasInfo,userInfo=_store$get.userInfo;var defaultContext={nick_name:userInfo.nickname,avatar:userInfo.avatar,role_name:userInfo.role_name,device_type:isPcClient?'2':'1',// 设备类型 1手机端 2PC 0未检测
  ...
  is_kick:userInfo.is_kick};var defaultOptions={context:defaultContext,appId:paasInfo.paas_app_id,accountId:userInfo.third_party_user_id,channelId:paasInfo.channel_id,token:paasInfo.paas_access_token,hide:false// 是否隐身
  };return defaultOptions;}/**
         * 注册聊天事件
  ...
  _this2.$emit('LEFT',msg);});}/**
         ...
         * @param {String} data 消息体
         * @returns {Promise}
         */},{key:"emitCustomChat",value:function emitCustomChat(data){return this.instance.emitCustomMsg(data);}/**
         * 发送文档消息（不对外）
         * @param {Object} data 消息体
         * @returns {Promise}
         */},{key:"emitDocMsg",value:function emitDocMsg(data){return this.instance.emitDocMsg(data);}/**
         * 发送房间消息（不对外）
         * @param {Object} data 消息体
         * @returns {Promise}
         */},{key:"emitRoomMsg",value:function emitRoomMsg(data){var retData=JSON.stringify(data);return this.instance.emitRoomMsg(retData);}/**
         * 获取用户列表信息
         ...
         * @param {Object} params 分页参数
         * @returns {Promise}
         */},{key:"getOnlineInfo",value:function getOnlineInfo(params){var _this5=this;var defaultParams={currPage:1,pageSize:200};var retParams=merge.recursive({},defaultParams,params);return new Promise(function(resolve,reject){_this5.instance.getOnlineInfo(retParams,resolve,reject);});}}]);return ChatModule;}(BaseModule);var _excluded=["key"];var DocModule=/*#__PURE__*/function(_BaseModule){_inherits(DocModule,_BaseModule);var _super=_createSuper(DocModule);function DocModule(options){var _this;_classCallCheck(this,DocModule);_this=_super.call(this,options);_this.instance=null;_this.children=[];return _this;}_createClass(DocModule,[{key:"init",value:function init(){var _this2=this;var customOptions=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var defaultOptions=this.initDefaultOptions();var options=merge.recursive({},defaultOptions,customOptions);console.log('doc options:',options);return new Promise(function(resolve,reject){var onSuccess=function onSuccess(){console.log('saasSDK文档初始化成功');resolve();};var onFail=function onFail(failed){console.error('saasSDK文档初始化失败',failed.msg);reject();};_this2.instance=window.VHDocSDK.createInstance(options,onSuccess,onFail);_this2.listenEvents();});}},{key:"initDefaultOptions",value:function initDefaultOptions(){isPc();var _store$get=store.get('roomInitData'),_store$get$paasInfo=_store$get.paasInfo,paasInfo=_store$get$paasInfo===void 0?{}:_store$get$paasInfo,_store$get$userInfo=_store$get.userInfo,userInfo=_store$get$userInfo===void 0?{}:_store$get$userInfo;var defaultOptions={accountId:userInfo===null||userInfo===void 0?void 0:userInfo.third_party_user_id,roomId:paasInfo===null||paasInfo===void 0?void 0:paasInfo.room_id,channelId:paasInfo===null||paasInfo===void 0?void 0:paasInfo.channel_id,// 频道id 必须
  appId:paasInfo===null||paasInfo===void 0?void 0:paasInfo.paas_app_id,// appId 必须
  role:userInfo===null||userInfo===void 0?void 0:userInfo.role_name,// 角色 必须
  ...
  this.instance.on(VHDocSDK.Event.DOCUMENT_LOAD_COMPLETE,function(data){console.log('doc 加载完成');_this3.$emit(VHDocSDK.Event.DOCUMENT_LOAD_COMPLETE,data);});// 开关变换
  ...
  this.instance.on(VHDocSDK.Event.ALL_COMPLETE,function(data,s1,s2){console.log('doc 所有文档加载完成',data,s1,s2);_this3.$emit(VHDocSDK.Event.ALL_COMPLETE,data);});// 正在演示的文档被删除(文档不存在)
  ...
  strokeWidth:4// 正数 Number
       ...
       * @param {*} failCb 
       * 
       */_createClass(InteractiveModule,[{key:"init",value:function init(){var _this2=this;var customOptions=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var successCb=arguments.length>1&&arguments[1]!==undefined?arguments[1]:function(){};var failCb=arguments.length>2&&arguments[2]!==undefined?arguments[2]:function(){};console.log('customoptions',customOptions);console.log('store',store);var defaultOptions={appId:store.get('roomInitData').paasInfo.paas_app_id,// 互动应用ID，必填
  ...
  broadcastConfig:store.get('roomInitData').userInfo.role_name==1?{layout:customOptions.layout||VhallRTC.CANVAS_ADAPTIVE_LAYOUT_GRID_MODE,// 旁路布局，选填 默认大屏铺满，一行5个悬浮于下面
  ...
  precastPic:false,border:customOptions.border||{// 旁路边框属性
  width:2,color:'0x666666'}}:{}// 自动旁路   开启旁路直播方法所需参数
  };var options=merge.recursive({},defaultOptions,customOptions);console.log("optionssssssssssssssssssssssssssss",options);return new Promise(function(resolve,reject){var onSuccess=function onSuccess(event){_this2.instance=event.vhallrtc;_this2.currentStreams=event.currentStreams;_this2.listenEvents();console.log('init interactive sdk success:',event);window.interactiveSdk=event;successCb(event);resolve(event);};var onFail=function onFail(event){console.log('fail:',event);failCb(event);reject(event);};VhallRTC.createInstance(options,onSuccess,onFail);});}},{key:"listenEvents",value:function listenEvents(){var _this3=this;this.instance.on(VhallRTC.EVENT_REMOTESTREAM_ADD,function(e){// 远端流加入事件
  console.log('5555555remote stream added');_this3.$emit(VhallRTC.EVENT_REMOTESTREAM_ADD,e);});this.instance.on(VhallRTC.EVENT_REMOTESTREAM_REMOVED,function(e){// 远端流离开事件
  _this3.$emit(VhallRTC.EVENT_REMOTESTREAM_REMOVED,e);});this.instance.on(VhallRTC.EVENT_ROOM_EXCDISCONNECTED,function(e){// 房间信令异常断开事件
  _this3.$emit(VhallRTC.EVENT_ROOM_EXCDISCONNECTED,e);});this.instance.on(VhallRTC.EVENT_REMOTESTREAM_MUTE,function(e){// 远端流音视频状态改变事件
  _this3.$emit(VhallRTC.EVENT_REMOTESTREAM_MUTE,e);});this.instance.on(VhallRTC.EVENT_REMOTESTREAM_FAILED,function(e){// 本地推流或订阅远端流异常断开事件
  _this3.$emit(VhallRTC.EVENT_REMOTESTREAM_FAILED,e);});this.instance.on(VhallRTC.EVENT_STREAM_END,function(e){// 本地流采集停止事件(处理拔出设备和桌面共享停止时)
  _this3.$emit(VhallRTC.EVENT_STREAM_END,e);});this.instance.on(VhallRTC.EVENT_STREAM_STUNK,function(e){// 本地流视频发送帧率异常事件
  _this3.$emit(VhallRTC.EVENT_STREAM_STUNK,e);});this.instance.on(VhallRTC.EVENT_DEVICE_CHANGE,function(e){// 新增设备或移除设备时触发
  _this3.$emit(VhallRTC.EVENT_DEVICE_CHANGE,e);});}/**
         * 销毁互动sdk
         * @returns -- 销毁互动sdk
         */},{key:"destroyInit",value:function destroyInit(){var _this4=this;return new Promise(function(resolve,reject){_this4.instance.destroyInstance({}).then(function(){resolve();_this4.instance=null;})["catch"](function(error){reject(error);});});}/**
         * 创建本地流
         * @param obt {Object} - sdk init stream base info config
         * @return {Promise} - 创建成功后的promise 回调
         *
         */},{key:"createLocalStream",value:function createLocalStream(){var _this5=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){_this5.instance.createStream(options).then(function(data){resolve(data.streamId);})["catch"](function(error){if(store.get('roomInitData').userInfo.role_name!=1){//上麦人员无法创建本地流上麦，向外抛出信息
  var toSpeakInfo=_objectSpread2({roleName:store.get('roomInitData').userInfo.role_name,accountId:store.get('roomInitData').userInfo.third_party_user_id,nickName:store.get('roomInitData').userInfo.nickname},error);reject(toSpeakInfo);}else {reject(error);}});});}/**
         * 创建摄像头视频流
         * @param obt {Object} - sdk init stream base info config  videoNode: 容器 audioDevice: 音频的Id videoDevice:视频的设备Id profile:视频推流的质量
         * @return {Promise} - 创建成功后的promise 回调
         *
         */},{key:"createLocalVideoStream",value:function createLocalVideoStream(){var _this6=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var addConfig=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return new Promise(function(resolve,reject){var defaultOptions={videoNode:options.videoNode,// 必填，传入本地视频显示容器ID
  ...
  };var params=merge.recursive({},defaultOptions,addConfig);console.log('pass params::',params);_this6.instance.createStream(params).then(function(data){resolve(data.streamId);})["catch"](function(error){if(store.get('roomInitData').userInfo.role_name!=1){//上麦人员无法创建本地流上麦，向外抛出信息
  var toSpeakInfo=_objectSpread2({roleName:store.get('roomInitData').userInfo.role_name,accountId:store.get('roomInitData').userInfo.third_party_user_id,nickName:store.get('roomInitData').userInfo.nickname},error);reject(toSpeakInfo);}else {reject(error);}});});}/**
         * 创建桌面共享流
         * @param obt {Object} - sdk init stream base info config  videoNode: 容器 speaker: 是否采集扬声器 profile: 视频的质量 addConfig: 扩展配置项
         * @return {Promise} - 创建成功后的promise 回调
         *
         */},{key:"createLocaldesktopStream",value:function createLocaldesktopStream(){var _this7=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var addConfig=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return new Promise(function(resolve,reject){var defaultOptions={videoNode:options.videoNode,// 必填，传入本地视频显示容器ID
  ...
  attributes:JSON.stringify({roleName:store.get('roomInitData').userInfo.role_name,accountId:store.get('roomInitData').userInfo.third_party_user_id,nickName:store.get('roomInitData').userInfo.nickname})//选填，自定义信息，支持字符串类型
  };var params=merge.recursive({},defaultOptions,addConfig);_this7.instance.createStream(params).then(function(data){resolve(data.streamId);})["catch"](function(error){if(store.get('roomInitData').userInfo.role_name!=1){//上麦人员无法创建本地流上麦，向外抛出信息
  var toSpeakInfo=_objectSpread2({roleName:store.get('roomInitData').userInfo.role_name,accountId:store.get('roomInitData').userInfo.third_party_user_id,nickName:store.get('roomInitData').userInfo.nickname},error);reject(toSpeakInfo);}else {reject(error);}});});}/**
         * 创建本地音频流
         * @param obt {Object} - sdk init stream base info config  videoNode: 容器 audioDevice: 音频Id addConfig: 扩展配置项
         * @return {Promise} - 创建成功后的promise 回调
         *
         */},{key:"createLocalAudioStream",value:function createLocalAudioStream(){var _this8=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var addConfig=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return new Promise(function(resolve,reject){var defaultOptions={videoNode:options.videoNode,// 必填，传入本地视频显示容器ID
  audio:true,// 选填，是否采集音频设备，默认为true
  ...
  };var params=merge.recursive({},defaultOptions,addConfig);_this8.instance.createStream(params).then(function(data){resolve(data.streamId);})["catch"](function(error){reject(error);});});}/**
         * 创建图片推流
         * @param obt {Object} - sdk init stream base info config  videoNode: 容器 videoTrack: MediaStreamTrack对象,采集图像 addConfig: 扩展配置项
         * @return {Promise} - 创建成功后的promise 回调
         *
         */},{key:"createLocalPhotoStream",value:function createLocalPhotoStream(){var _this9=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var addConfig=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return new Promise(function(resolve,reject){var defaultOptions={videoNode:options.videoNode,// 传入本地视频显示容器，必填
  audio:true,video:false,//如参会者没有摄像头，则传入false
  videoTrack:options.videoTrack,//MediaStreamTrack对象
  attributes:JSON.stringify({roleName:store.get('roomInitData').userInfo.role_name,accountId:store.get('roomInitData').userInfo.third_party_user_id,nickName:store.get('roomInitData').userInfo.nickname})//选填，自定义信息，支持字符串类型
  };var params=merge.recursive({},defaultOptions,addConfig);_this9.instance.createStream(params).then(function(data){resolve(data.streamId);})["catch"](function(error){reject(error);});});}/**
         * 销毁本地流
         * @param {String} streamId -- 要销毁的流Id
         * @returns 
         */},{key:"destroyStream",value:function destroyStream(){var _this10=this;var streamId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'';return new Promise(function(resolve,reject){_this10.instance.destroyStream({streamId:streamId}).then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         * 推送本地流到远端
         * @param {Object} options publish stream base info config  streamId：要推的流Id，accountId:用户Id
         * @return {Promise} - 推流成功后的promise 回调
         */},{key:"publishStream",value:function publishStream(){var _this11=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){_this11.instance.publish({streamId:options.streamId,accountId:options.accountId}).then(function(data){resolve(data);})["catch"](function(errInfo){reject(errInfo);});});}/**
         * 取消推送到远端的流
         * @param {String} streamId 要取消推的流Id
         * @returns {Promise} - 取消推流成功后的promise 回调
        */},{key:"unpublishStream",value:function unpublishStream(){var _this12=this;var streamId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'';return new Promise(function(resolve,reject){_this12.instance.unpublish({streamId:streamId}).then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         * 订阅远端流
  ...
  video:options.mute&&options.mute.audio||false// 是否关闭视频，默认false
         ...
         */},{key:"unSubscribeStream",value:function unSubscribeStream(){var _this14=this;var streamId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'';return new Promise(function(resolve,reject){_this14.instance.unsubscribe({streamId:streamId}).then(function(data){resolve(data);})["catch"](function(error){reject(error);});});}/**
         * 设置大小流
         * @param {Object} options streamId: 需要设置的流Id  dual: 0为小流 1为大流
         * @returns {Promise} - 设置订阅大小流成功后的promise回调
         */},{key:"setDual",value:function setDual(){var _this15=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){var params={streamId:options.streamId,dual:options.dual};_this15.instance.setDual(params).then(function(data){resolve(data);})["catch"](function(error){reject(error);});});}/**
         * 改变视频的禁用和启用
         * @param {Object} options streamId: 对哪一路流进行操作的流Id  isMute: true为禁用，false为启用
         * @returns {Promise} - 改变视频的禁用与开启后的promise 回调
         */},{key:"muteVideo",value:function muteVideo(){var _this16=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){var params={streamId:options.streamId,isMute:options.isMute};_this16.instance.muteVideo(params).then(function(data){resolve(data);})["catch"](function(error){reject(error);});});}/**
         * 改变音频的禁用和启用
         * @param {Object} options streamId: 对哪一路流进行操作的流Id isMute: true为禁用，false为启用
         * @returns {Promise} - 改变音频的禁用与开启后的promise 回调
         */},{key:"muteAudio",value:function muteAudio(){var _this17=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){var params={streamId:options.streamId,isMute:options.isMute};_this17.instance.muteAudio(params).then(function(data){resolve(data);})["catch"](function(error){reject(error);});});}/**
         * 开启旁路
         ...
         */},{key:"startBroadCast",value:function startBroadCast(){var _this18=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};var addConfig=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};return new Promise(function(resolve,reject){var defaultOptions={layout:options.layout||VhallRTC.CANVAS_ADAPTIVE_LAYOUT_GRID_MODE,// 旁路布局，选填 默认大屏铺满，一行5个悬浮于下面
  ...
  width:2,color:'0x666666'}};var params=merge.recursive({},defaultOptions,addConfig);_this18.instance.startBroadCast(params).then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         ...
         */},{key:"setBroadCastLayout",value:function setBroadCastLayout(){var _this20=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){_this20.instance.setBroadCastLayout({layout:options.layout}).then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         * 配置旁路布局自适应模式
         * @param {Object} options --  layout: 指定旁路布局模板
         * @returns {Promise} - 配置旁路布局自适应模式的promise回调
         */},{key:"setBroadCastAdaptiveLayoutMode",value:function setBroadCastAdaptiveLayoutMode(){var _this21=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){_this21.instance.setBroadCastAdaptiveLayoutMode({adaptiveLayoutMode:options.adaptiveLayoutMode||VhallRTC.CANVAS_ADAPTIVE_LAYOUT_GRID_MODE}).then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         * 动态配置旁路主屏
         * @param {String} mainScreenStreamId -- 将哪路流设置成主屏的流Id
         * @returns {Promise} - 动态配置旁路主屏的promise回调
         */},{key:"setBroadCastScreen",value:function setBroadCastScreen(){var _this22=this;var mainScreenStreamId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'';return new Promise(function(resolve,reject){_this22.instance.setBroadCastScreen({mainScreenStreamId:mainScreenStreamId}).then(function(){resolve();})["catch"](function(error){reject(error);});});}/**
         * 获取全部音视频列表
         * @returns {Promise} - 获取全部音视频列表的promise回调
         */},{key:"getDevices",value:function getDevices(){var _this23=this;return new Promise(function(resolve,reject){_this23.instance.getDevices().then(function(devices){resolve(devices);})["catch"](function(error){reject(error);});});}/**
         * 获取摄像头列表
         * @returns {Promise} - 获取摄像头列表的promise回调
         */},{key:"getCameras",value:function getCameras(){var _this24=this;return new Promise(function(resolve,reject){_this24.instance.getCameras().then(function(devices){resolve(devices);})["catch"](function(error){reject(error);});});}/**
         * 获取麦克风列表
         * @returns {Promise} - 获取麦克风列表的promise回调
         */},{key:"getMicrophones",value:function getMicrophones(){var _this25=this;return new Promise(function(resolve,reject){_this25.instance.getMicrophones().then(function(devices){resolve(devices);})["catch"](function(error){reject(error);});});}/**
         * 获取扬声器列表
         * @returns {Promise} - 获取扬声器列表的promise回调
         */},{key:"getSpeakers",value:function getSpeakers(){var _this26=this;return new Promise(function(resolve,reject){_this26.instance.getSpeakers().then(function(devices){resolve(devices);})["catch"](function(error){reject(error);});});}/**
         * 获取设备的分辨率
         * @param {String} deviceId -- 摄像头设备的Id
         * @returns {Promise} - 分辨率获取之后的promise回调
         */},{key:"getVideoConstraints",value:function getVideoConstraints(deviceId){var _this27=this;return new Promise(function(resolve,reject){_this27.instance.getVideoConstraints({deviceId:deviceId},function(data){resolve(data);},function(error){reject(error);});});}/**
         * 配置本地流视频质量参数
         * @param {Object} options --  streamId: 切换本地流Id profile: 必填，互动视频质量参数
         * @returns {Promise} - 配置本地流视频质量参数的promise回调
         */},{key:"setVideoProfile",value:function setVideoProfile(){var _this28=this;var options=arguments.length>0&&arguments[0]!==undefined?arguments[0]:{};return new Promise(function(resolve,reject){_this28.instance.setVideoProfile({streamId:options.streamId,profile:options.profile},function(data){resolve(data);},function(error){reject(error);});});}/**
         * 获取房间流信息
         * @param {Object} options --  streamId: 切换本地流Id profile: 必填，互动视频质量参数
         * @returns {Promise} - 配置本地流视频质量参数的promise回调
  ...
  return this.instance.enterFullScreen(failure);}},{key:"exitFullScreen",value:function exitFullScreen(failure){// 退出全屏
  return this.instance.exitFullScreen(failure);}},{key:"setMute",value:function setMute(isMute,failure){return this.instance.setMute(isMute,failure);}},{key:"getVolume",value:function getVolume(){// 获取音量
  return this.instance.getVolume();}},{key:"setVolume",value:function setVolume(volume,failure){// 设置音量
  return this.instance.setVolume(volume,failure);}},{key:"getDuration",value:function getDuration(failure){// 获取当前视频总时长
  return this.instance.getDuration(failure);}},{key:"getCurrentTime",value:function getCurrentTime(failure){// 获取当前视频播放时间
  return this.instance.getCurrentTime(failure);}},{key:"setCurrentTime",value:function setCurrentTime(time,failure){// 设置当前播放时间
  return this.instance.setCurrentTime(time,failure);}},{key:"getUsableSpeed",value:function getUsableSpeed(failure){// 获取当前可选倍速
  return this.instance.getUsableSpeed(failure);}},{key:"setPlaySpeed",value:function setPlaySpeed(val,failure){// 设置倍速播放
  ...
  var initRecordApi = function initRecordApi() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    var _contextServer$get7 = contextServer.get('roomBaseServer'),
        state = _contextServer$get7.state;

    var _contextServer$get8 = contextServer.get('roomInitGroupServer');
        _contextServer$get8.state;
  ...
  var getRoomToolStatus = function getRoomToolStatus() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    var _contextServer$get9 = contextServer.get('roomBaseServer'),
        state = _contextServer$get9.state;

    var _contextServer$get10 = contextServer.get('roomInitGroupServer');
        _contextServer$get10.state;
  ...
  function usePlayerServer() {
    ...
    var addBarrage = function addBarrage(val) {
    ...
    var openBarrage = function openBarrage() {
      return state.playerInstance.toggleBarrage(true);
    }; //关闭弹幕显示


    var closeBarrage = function closeBarrage() {
      return state.playerInstance.toggleBarrage(false);
    }; //清除弹幕显示


    var clearBarrage = function clearBarrage() {
    ...
    return {
      ...
      closeBarrage: closeBarrage,
      clearBarrage: clearBarrage,
  ...
  function useRoomBaseServer() {
    ...
    var initReplayRecord = function initReplayRecord() {
      var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                oldGroupInitData = JSON.parse(JSON.stringify(groupInitData));
                console.log('domain -------- oldGroupInitData', oldGroupInitData); // 如果在主直播间，并且 group_ids 中包括主直播间
              ...
              case 7:
                _groupInitData = roomBaseServer.state.groupInitData;
                console.log('domain -------- groupInitData', _groupInitData); // 如果新的小组跟之前的小组不一样则需要关心,否则不需要关心
