(function (global, factory) {
  ...
  }};var options=merge.recursive({},defaultOptions,customOptions);return this.instance.createBoard(options);}},{key:"createDocument",value:function createDocument(customOptions){var _defaultOptions;var elId=this.instance.createUUID('document');// 容器id，必须用此方法创建，文档传入document，返回唯一id
  ...
  console.log('succcccccccccceeesssss!');_this2.$emit('interactive_REMOTESTREAM_ADD',e);});this.instance.on(VhallRTC.EVENT_REMOTESTREAM_REMOVED,function(e){// 远端流离开事件
  ...
  _this2.$emit('interactive_REMOTESTREAM_FAILED',e);});this.instance.on(VhallRTC.EVENT_STREAM_END,function(e){// 本地流采集停止事件(处理拔出设备和桌面共享停止时)
  _this2.$emit('interactive_STREAM_END',e);});this.instance.on(VhallRTC.EVENT_STREAM_STUNK,function(e){// 本地流视频发送帧率异常事件
  _this2.$emit('interactive_STREAM_STUNK',e);});this.instance.on(VhallRTC.EVENT_DEVICE_CHANGE,function(e){// 新增设备或移除设备时触发
