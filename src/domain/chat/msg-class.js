...
export default class Msg {
  constructor(params) {
    ...
    const { avatar, nickname, role_name, user_id, third_party_user_id } = roomserver.state.watchInitData.join_info;
    console.log("join_info", roomserver.state.watchInitData.join_info);
    //分组相关逻辑判断
