    ...
    _createClass(InteractiveModule, [{
      ...
      */
      ...
      value: function setBroadCastAdaptiveLayoutMode() {
        ...
        var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
        return new Promise(function (resolve, reject) {
          _this21.instance.setBroadCastAdaptiveLayoutMode({
      ...
      value: function setBroadCastScreen() {
        ...
        return new Promise(function (resolve, reject) {
          _this22.instance.setBroadCastScreen({
      ...
      value: function getDevices() {
        ...
        return new Promise(function (resolve, reject) {
          _this23.instance.getDevices().then(function (devices) {
            resolve(devices);
          })["catch"](function (error) {
            reject(error);
          });
      ...
      value: function getCameras() {
        ...
        return new Promise(function (resolve, reject) {
          _this24.instance.getCameras().then(function (devices) {
            resolve(devices);
          })["catch"](function (error) {
            reject(error);
          });
      ...
      value: function getMicrophones() {
        ...
        return new Promise(function (resolve, reject) {
          _this25.instance.getMicrophones().then(function (devices) {
            resolve(devices);
          })["catch"](function (error) {
            reject(error);
          });
      ...
      value: function getSpeakers() {
        ...
        return new Promise(function (resolve, reject) {
          _this26.instance.getSpeakers().then(function (devices) {
            resolve(devices);
          })["catch"](function (error) {
            reject(error);
          });
