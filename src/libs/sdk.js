        ...
        _createClass(DocModule, [
            {
                ...
                value: function init() {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        _this2.instance = window.VHDocSDK.createInstance(
                            options,
                            onSuccess,
                            onFail
                        );
                    ...
                    var defaultOptions = {
                        accountId:
                            userInfo === null || userInfo === void 0
                                ? void 0
                                : userInfo.third_party_user_id,
                        roomId:
                            paasInfo === null || paasInfo === void 0 ? void 0 : paasInfo.room_id,
                        channelId:
                            paasInfo === null || paasInfo === void 0 ? void 0 : paasInfo.channel_id,
                        // 频道id 必须
                        appId:
                            paasInfo === null || paasInfo === void 0
                                ? void 0
                                : paasInfo.paas_app_id,
                        // appId 必须
                        role:
                            userInfo === null || userInfo === void 0 ? void 0 : userInfo.role_name,
                        // 角色 必须
                        isVod: false,
                        // 是否是回放 必须
            ...
            },
            {
                ...
                value: function listenEvents() {
                    ...
                    // 创建容器事件
                    this.instance.on(VHDocSDK.Event.CREATE_CONTAINER, function (data) {
                        _this3.$emit(VHDocSDK.Event.CREATE_CONTAINER, data);
                    }); // 选择容器

                    this.instance.on(VHDocSDK.Event.SELECT_CONTAINER, function (data) {
                        _this3.$emit(VHDocSDK.Event.SELECT_CONTAINER, data);
                    }); // 当前文档加载完成
                    ...
                    this.instance.on(VHDocSDK.Event.SWITCH_CHANGE, function (status) {
                        _this3.$emit(VHDocSDK.Event.SWITCH_CHANGE, status);
                    }); // 删除容器时候触发的事件
                    ...
                    this.instance.on(VHDocSDK.Event.DOCUMENT_NOT_EXIT, function (_ref) {
                        ...
                        _this3.$emit(VHDocSDK.Event.DOCUMENT_NOT_EXIT, {
                            cid: cid,
                            docId: docId
                        });
                    }); // 翻页事件
                    ...
                    this.instance.on(
                        VHDocSDK.Event.VOD_CUEPOINT_LOAD_COMPLETE,
                        function (event, s1, s2) {
                    ...
                    this.instance.on(VHDocSDK.Event.PLAYBACKCOMPLETE, function (event) {
                        _this3.$emit(VHDocSDK.Event.PLAYBACKCOMPLETE, event);
                    });
                }
            },
            {
            ...
            },
            {
                ...
                value: function createDocument(customOptions) {
                    ...
                    var defaultOptions =
                        ...
                        _defineProperty(_defaultOptions, 'docId', 'yyy'),
                        _defineProperty(_defaultOptions, 'noDispatch', false),
                        _defineProperty(_defaultOptions, 'option', {
                            // 非必填，画笔预设选项
                            graphicType: VHDocSDK.GRAPHIC.PEN,
                            // 选项请参考画笔预设值,
                            stroke: '#000',
            ...
            },
            {
                ...
                value: function callPaasSDK() {
                    ...
                    (_this$instance$key = this.instance[key]).call.apply(
                        _this$instance$key,
                        [this.instance[key]].concat(_toConsumableArray(args))
                    );
                }
            }
        ]);
        ...
        _createClass(InteractiveModule, [
            {
                ...
                value: function init() {
                    ...
                    var defaultOptions = {
                        ...
                        broadcastConfig:
                            store.get('roomInitData').userInfo.role_name == 1
                                ? {
                                      layout:
                                          customOptions.layout ||
                                          VhallRTC.CANVAS_ADAPTIVE_LAYOUT_GRID_MODE,
                                      // 旁路布局，选填 默认大屏铺满，一行5个悬浮于下面
                                      profile:
                                          customOptions.profile ||
                                          VhallRTC.BROADCAST_VIDEO_PROFILE_1080P_1,
                                      // 旁路直播视频质量参数
                    ...
                    return new Promise(function (resolve, reject) {
                        var onSuccess = function onSuccess(event) {
                            ...
                            _this2.currentStreams = event.currentStreams;
                                    ...
                                    var toSpeakInfo = _objectSpread2(
                                        {
                                            ...
                                            accountId:
                                                store.get('roomInitData').userInfo
                                                    .third_party_user_id,
                    ...
                    return new Promise(function (resolve, reject) {
                        var defaultOptions = {
                            ...
                            profile:
                                ...
                                VhallRTC.RTC_VIDEO_PROFILE_1080P_16x9_H,
            ...
            },
            {
                ...
                value: function startBroadCast() {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        if (
                            options.adaptiveLayoutMode !== undefined ||
                            options.adaptiveLayoutMode !== null
                        ) {
            ...
            },
            {
                ...
                value: function getVideoConstraints(deviceId) {
                    ...
                    return new Promise(function (resolve, reject) {
                        _this27.instance.getVideoConstraints(
                            {
                                deviceId: deviceId
                            },
                            function (data) {
            ...
            },
            {
                ...
                value: function setVideoProfile() {
                    ...
                    var options =
                        arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
                    return new Promise(function (resolve, reject) {
                        _this28.instance.setVideoProfile(
                            {
                                streamId: options.streamId,
        ...
        _createClass(VhallSaasSDK, [
            ...
            },
            {
                ...
                value: function initReceiveLive(options) {
                    ...
                    return new Promise(function (resolve, reject) {
                        _this2.request.live[receiveApi[options.receiveType]](options).then(
                            function (res) {
                                if (res.code === 200) {
                                    store.set('roomInitData', getRoomInfo(res));
                                    resolve(res);
